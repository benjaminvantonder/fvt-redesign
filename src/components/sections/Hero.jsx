    ...
    <section className="relative flex h-screen min-h-[600px] items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 text-center lg:px-8">
        ...
        <motion.h1
          ...
          className="mt-6 font-serif text-5xl font-semibold text-white sm:text-6xl md:text-7xl lg:text-8xl"
        >
          FVT Architecture
        </motion.h1>
        ...
        <motion.p
          ...
          className="mx-auto mt-6 max-w-xl text-lg italic leading-relaxed text-stone-300"
        >
